      ...
      <>
        <form className="crypto-login-form">
          <div className="mdc-text-field mdc-text-field--fullwidth crypto-margin-bottom-big">
            <QinglinInput
              fullWidth
              name={findKey(logupFormDetail, logupFormDetail.username)}
              label={logupFormDetail.username}
          ...
          <div className="mdc-text-field mdc-text-field--fullwidth crypto-margin-bottom-big">
            <QinglinInput
              fullWidth
              name={findKey(logupFormDetail, logupFormDetail.email)}
              label={logupFormDetail.email}
          ...
          <div className="mdc-text-field mdc-text-field--fullwidth ">
            <QinglinInput
              fullWidth
              name={findKey(logupFormDetail, logupFormDetail.password)}
              label={logupFormDetail.password}
          ...
          <div className="mdc-text-field mdc-text-field--fullwidth crypto-margin-bottom-big">
            <QinglinInput
              fullWidth
              name={findKey(logupFormDetail, logupFormDetail.confirm)}
              label={logupFormDetail.confirm}
          ...
          <div className="crypto-display-flex crypto-display-flex--space-between crypto-margin-bottom-big">
            <div className="mdc-form-field">
              ...
              <label>
                {logupFormDetail.agree}
                <a href="#">{logupFormDetail.agreement}</a>
              </label>
            </div>
          </div>
          <a
